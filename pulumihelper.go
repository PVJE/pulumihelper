...
func CreateNgw(ctx *pulumi.Context, name string, allocation_id string, subnet_id *ec2.Subnet, connectivity_type string, tagsMap pulumi.StringMap) (*ec2.NatGateway, error) {
